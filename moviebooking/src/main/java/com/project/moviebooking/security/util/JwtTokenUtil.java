...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateTokenWithCustomeExpirationDate(UserDetails userDetails, Date expirationDate) {
    	Map<String, Object> claims = new HashMap<>();
    	return doGenerateToken(claims, userDetails.getUsername(), expirationDate);
    }

    public String generateTokenWithUsernameAndCustomeExpirationDate(String username, Date expirationDate) {
    	Map<String, Object> claims = new HashMap<>();
    ...
    public Boolean validateMobileToken(String token, String tokenId) {
        final String mobileNo = getUsernameFromToken(token);
        return (mobileNo.equals(tokenId) && !isTokenExpired(token));
    }
